...
<head>
    ...
    <title>OVERTHINKING | PRINTING</title>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="copyright">
                                <p class="mb-0">&copy; <a
                                        href="#"
                                        target="_blank"> OVERTHINKING PRINTING </a> 2024. All Rights Reserved. | Repost by <a href='https://stokcoding.com/' title='draaacoding.com' target='_blank'>DraaaCoding.com</a>
                                        </p>
                            </div>
                        </div>
                        <div class="col-md-6">
